#ifndef LIEGE_FRAMEWORK_LOADED
#define LIEGE_FRAMEWORK_LOADED
...
// analyser::framework
//
// If you want to use the framework, call MAKE_LIEGE_FRAMEWORK(function) at
...
// =============================================================================
#define MAKE_LIEGE_FRAMEWORK(function)                                         \
  int main(int argc, char* argv[]) {                                           \
    try {                                                                      \
      liege::framework liege{argc, argv, (function)};                          \
      liege.run();                                                             \
      return 0;                                                                \
    } catch (...) {                                                            \
      return 1;                                                                \
...
private:
  ...
  liege_function_type liege_function_;
