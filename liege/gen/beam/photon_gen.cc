...
#include <TSpline.h>
#include <cmath>
#include <liege/core/assert.hh>
#include <liege/physics/kinematics.hh>
...
// =======================================================================================
namespace {
const liege::translation_map<liege::beam::bremsstrahlung::model>
    bs_model_translator{{"flat", liege::beam::bremsstrahlung::model::FLAT},
                        {"param", liege::beam::bremsstrahlung::model::PARAM},
                        {"approx", liege::beam::bremsstrahlung::model::APPROX},
                        {"exact", liege::beam::bremsstrahlung::model::EXACT}};
