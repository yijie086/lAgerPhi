...
#ifndef LAGER_GEN_LA_PHI_CLAS12_LOADED
#define LAGER_GEN_LA_PHI_CLAS12_LOADED
...
// =============================================================================
class phi_clas12 : public lA::generator {
public:
  using base_type = lA::generator;

  phi_clas12(const configuration& cf, const string_path& path,
